...
%BC.bot(3)=min(L_rate,R_rate); %temp approach MorrowTA 25 Oct 2016
BC.top(3)=min(L_rate,R_rate); %temp approach MorrowTA 25 Oct 2016

%BC.top_prof=(BC.right(4)-BC.left(4))/2*sin(linspace(-pi/2,pi/2,Nx))+(BC.right(4)-BC.left(4))/2+BC.left(4); % attempted sine outflow MorrowTA 25 Oct 2016
